...
app.post('/adminapi/v1/files/list', async (req, res) => {
...
app.post('/adminapi/v1/files/read', async (req, res) => {
    const name = req.body.filename
...
app.post('/adminapi/v1/files/write', async (req, res) => {
    const name = req.body.filename;
...
app.post('/adminapi/v1/files/delete', async (req, res) => {
    const name = req.body.filename;
    const filename = PROJECT_WORKSPACE_DIR + name;
    try {
