...
const staticDestPath = path.join(__dirname, '.next/standalone/apps/nextra/.next/static');

const publicSrcPath = path.join(__dirname, 'public');
const publicDestPath = path.join(__dirname, '.next/standalone/apps/nextra/public');
