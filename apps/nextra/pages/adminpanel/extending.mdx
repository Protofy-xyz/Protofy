...
## Changing Sidebar
You can change the content of sidebar panel going to `packages/app/boundles/custom/workspaces/admin.tsx`. All configurations of the following sections are
...
Previous state:
```typescript filename="packages/app/boundles/custom/workspaces/admin.tsx"
export default {
    "default": "/admin/pages",
    "label": "Workspace",
    "menu": {
...
```
New state:
```typescript {9} filename="packages/app/boundles/custom/workspaces/admin.tsx"
export default {
    "default": "/admin/pages",
    "label": "Workspace",
    "menu": {
...
```typescript {9-11} filename="packages/app/boundles/custom/workspaces/admin.tsx"
export default {
    "default": "/admin/pages",
    "label": "Workspace",
    "menu": {
