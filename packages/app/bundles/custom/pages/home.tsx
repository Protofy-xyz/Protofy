					...
					<ContainerLarge contain="layout" pos="relative" >
						...
						<YStack f={1} ov="hidden" space="$3" position="relative" pt="$14" mb="$4" >
							...
							<XCenterStack >
								...
								<XStack ai="center" jc="center" space="$2" $xxs={{
									// words web-only
									// @ts-ignore
									order: '-1',
									mx: '50%'
									...
									<NextLink href="/docs/intro/why-a-compiler" >
										<MainButton buttonProps={{ w: 120, h: 52 }} >
											How?
										</MainButton>
									</NextLink>
									<NextLink href="/docs/intro/introduction" >
										<MainButton buttonProps={{ w: 118, h: 52 }} >
											Docs
										</MainButton>
									</NextLink>
								</XStack>
				...
				<TintSection index={2} contain="paint layout" zi={1000} >
					...
					<ContainerLarge position="relative" >
						<YStack zi={1} space="$6" mb="$4" >
							<BlockTitle title="A better style system" subtitle="A multi-faceted optimizing compiler enables Lorem ipsum dolor" >
							</BlockTitle>
							< Spacer />
							<ThemeTint >
								<ActiveGroup >
									<ButtonGroup >
										<ActiveGroupButton activeId={0} >
											lorem
										</ActiveGroupButton>
										<ActiveGroupButton activeId={1} >
											ipsum
										</ActiveGroupButton>
										<ActiveGroupButton activeId={2} >
											dolor
										</ActiveGroupButton>
									</ButtonGroup>
					...
					<ElevatedArea >
						<ContainerLarge position="relative" >
							<SectionBox zi={1} bubble={true} gradient={true} >
								<BlockTitle title="Protofito is the king" subtitle={"Some cool charts"} >
								</BlockTitle>
							</SectionBox>
						</ContainerLarge>
					</ElevatedArea>
				...
				<Section sectionProps={{ index: 6, p: 0 }} >
					<ContainerLarge my={-5} position="relative" space="$8" >
						<SectionBox mt="$20" zi={1000} bubble={true} gradient={true} >
							<XStack ai="center" jc="center" >
								<BlockTitle title={"Hello world"} subtitle="badum ts!" >
								</BlockTitle>
							</XStack>
							<Theme reset={true} >
								<XStack p="$10" space="$5" >
