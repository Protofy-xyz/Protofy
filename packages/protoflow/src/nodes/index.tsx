...
export const nodeColors = Object.keys(NodeTypes).reduce((obj, key, i) => {
    return {
        ...obj,
        [key]: customNodeColors[key] ? customNodeColors[key] : nodeColorsPalette[i % nodeColorsPalette.length]
    }
}, {})
