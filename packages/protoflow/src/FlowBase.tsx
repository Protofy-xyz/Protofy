...
function useFlowsComms(
    { edges, nodeData, nodes },
    { setEdges, setNodesData, deleteNodes, setNodes, createNode, setNodeData },
    _customComponents, onSaveNodes, flowId, data 
) {
...
const FlowsBase = ({
    ...
    if (enableCommunicationInterface) {
        useFlowsComms({edges, nodeData, nodes}, {setEdges, setNodesData, deleteNodes, setNodes, createNode, setNodeData}, _customComponents, onSaveNodes, flowId, data)
    }
