...
export default {
    ...
    component: ({ pageState, initialItems, pageSession, extraData }: any) => {
        return (<Page height="100vh">
            <DefaultLayout title="Protofy" footer={null} description="Made with love from Barcelona">
                <XStack height="100vh" flex={1} overflow="scroll">
                    <AgentPanel agentName={agentName} />
                </XStack>
       
            </DefaultLayout>
            <Tinted>
                {<BubbleChat apiUrl="/api/v1/chatbots/eventChat" />}
            </Tinted>
        </Page>)
    },
