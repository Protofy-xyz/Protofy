...
export const Chip = ({ icon, text, bold, color }:{icon:any, text: string, bold: boolean, color: ColorProp}) => {
    return <XStack ai="center" jc="center" bc={color??'$color5'} p={2} px={"$3"} br={25}>
