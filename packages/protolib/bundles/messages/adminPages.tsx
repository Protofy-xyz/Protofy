...
import { withSession, ObjectGrid, Tinted, useTint, Chip, JSONViewer } from 'protolib'
import { useSubscription } from 'mqtt-react-hooks';
import { H2, Spacer, XStack, YStack, Text, Paragraph } from '@my/ui';
...
export default {
    'admin/messages': {
        component: ({ pageSession }: any) => {
            const [messages, setMessages] = useState([{ topic: 'juas', message: '{"name": "john", "age": 20}' }, { topic: "lel", message: '{"name": "johdn", "age": 22}' }])
