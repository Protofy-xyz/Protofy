...
export default {
    ...
    check: (node, nodeData) => node.type == "CallExpression" && nodeData.to == 'context.onEvent' && nodeData["param-4"] != "device" && nodeData["param-4"] != "device",
    getComponent: (node, nodeData, children) => <OnEventMask node={node} nodeData={nodeData} children={children} />,
    getInitialData: () => { return { to: 'context.onEvent', "param-1": { value: 'context', kind: "Identifier" }, "param-2": { value: '(event) =>', kind: "Identifier" }, "param-3": { value: "", kind: "StringLiteral" }, "param-4": { value: '', kind: "StringLiteral" } } },
