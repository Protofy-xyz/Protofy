...
export const PromptAtom = atom<PromptContext[]>([{
    ...
    generate: (prompt) => {
        ...
        There is a reverse proxy on port 8080, with all the needed routing configured to proxy requests to /api to :4001, /adminapi to :4002 and all other router to :4000  (nextjs).
